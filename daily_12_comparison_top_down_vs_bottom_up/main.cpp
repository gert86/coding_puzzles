...
int main()
{
    ...
    vector<int> test_vector_01;
    test_vector_01.push_back(1);  // Expected:  1
    test_vector_01.push_back(2);  // Expected:  2
    test_vector_01.push_back(3);  // Expected:  3
    test_vector_01.push_back(4);  // Expected:  5
    test_vector_01.push_back(5);  // Expected:  8
    test_vector_01.push_back(6);  // Expected: 13
    for(int i=0; i<test_vector_01.size(); i++)
    {
        ...
        if (mode == 1)  num_possibilities = numPossibilities01(test_vector_01[i], valid_steps_01, memo);
        if (mode == 2)  num_possibilities = numPossibilities02(test_vector_01[i], valid_steps_01, memo, 0);
        if (mode == 3)  num_possibilities = numPossibilities03(test_vector_01[i], valid_steps_01);
        cout << "Testcase A: For N=" << test_vector_01[i] << " the number of possibilities is " << num_possibilities << endl;
    }
    cout << "----------------------------" << endl;

    // Test case B: 1, 3 or 5 steps at a time
    vector<int> valid_steps_02 = {1, 3, 5};
    vector<int> test_vector_02;
    test_vector_02.push_back(1);  // Expected: 1
    test_vector_02.push_back(2);  // Expected: 1
    test_vector_02.push_back(3);  // Expected: 2
    test_vector_02.push_back(4);  // Expected: 3
    test_vector_02.push_back(5);  // Expected: 5
    test_vector_02.push_back(6);  // Expected: 8
    for(int i=0; i<test_vector_02.size(); i++)
    {
        ...
        int num_possibilities = -1;
        if (mode == 1)  num_possibilities = numPossibilities01(test_vector_02[i], valid_steps_02, memo);
        if (mode == 2)  num_possibilities = numPossibilities02(test_vector_02[i], valid_steps_02, memo, 0);
        if (mode == 3)  num_possibilities = numPossibilities03(test_vector_02[i], valid_steps_02);
        cout << "Testcase B: For N=" << test_vector_02[i] << " the number of possibilities is " << num_possibilities << endl;
    }
